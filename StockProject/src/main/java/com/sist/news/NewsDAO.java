...
public class NewsDAO {
    ...
    public void newsSave(String data)
    {
    	try
    	{
    		String path="C:\\Users\\sist\\git\\LastProject\\StockProject\\src\\main\\webapp\\news\\news.txt";
    ...
    public void createImage()
    {
    	try
    	{
    		...
    		rc.voidEval("f<-file(\"C:/Users/sist/git/LastProject/StockProject/src/main/webapp/news/news.txt\")");
    		...
    		rc.voidEval("png(\"C:/springDev/springStudy/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/StockProject/news/news.png\")");
    		...
    		rc.voidEval("dev.off()");
    		rc.close();
    		File file=new File("C:\\springDev\\springStudy\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps\\StockProject\\news\\news.png");
    		FileInputStream fis=new FileInputStream(file);
    		FileOutputStream fos=new FileOutputStream("C:\\Users\\sist\\git\\LastProject\\StockProject\\src\\main\\webapp\\news\\news.png");
