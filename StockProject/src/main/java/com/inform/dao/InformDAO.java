...
public class InformDAO {
	//Samsung SDS,KOSPI : 서비스업,WICS : IT서비스,BPS 53,164,PER 49.94,업종PER 58.05,PBR 5.01,배당수익률 0.19%,
		...
		public  String company_gaeyo(String code) throws IOException{
		...
		public String company_info(String code) throws IOException{
			  Document document=Jsoup.connect("http://companyinfo.stock.naver.com/v1/company/c1020001.aspx?cmp_cd="+code).get();
				...
				return company_data3;
				//서울특별시 송파구 올림픽로35길 125(신천동)_http://www.sds.samsung.co.kr_02)6155-3114_1985/05/01 (상장일: 2014/11/14)_전동수_삼성_14,216 (2015/09)_77,377,800 주 / 0 주_삼정회계법인_한국예탁결제원_()
		}
		public String recent_date(String code) throws IOException{
			...
			return company_data4;
			//2015/06_2015/06_2015/04_2015/03/13_2015/03_
		}
		public String recent_info(String code) throws IOException{
			String company_data5="";
			Document document=Jsoup.connect("http://companyinfo.stock.naver.com/v1/company/c1020001.aspx?cmp_cd=018260").get();
			...
			return company_data5;
		}
		public String product(String code) throws IOException{
			...
			return company_data6;
			//IT서비스_물류BPO_ _ _ _ _ 
		}
		public String product_rate(String code) throws IOException{
			...
			return company_data7;
			//67.68_32.32_ _ _ _ _ 
		}
		public String sisae(String code) throws IOException{
			String company_data8="";
			Document document=Jsoup.connect("http://companyinfo.stock.naver.com/v1/company/c1010001.aspx?cmp_cd=018260").get();
	...
	/*public static void main(String[] args) throws Exception {
		String code="018260";
		InformVO c=company_sinfo(code);
		System.out.println(c.getD1_name());
		}*/
	}
